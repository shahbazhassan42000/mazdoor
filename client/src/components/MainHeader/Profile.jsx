...
const Profile = ({setProfile}) => {
  ...
  const dispatch=useDispatch();
    return (
        <div
            className="absolute top-14 z-10 -right-4 bg-[#fff] flex flex-col space-y-3 absolute py-4 w-[304px] rounded-[3px] shadow-[0_8px_16px_-4px_#091e4240]">
            ...
            <div className="flex space-x-3 items-center mx-4 border-b border-b-[#091e4221] pb-3">
                <div className="relative flex justify-center items-center py-2 h-[45px] w-[35px] rounded-[50%]">
                    <img className="object-cover w-[35px] h-[35px] rounded-[50%]" title={user.name} src={user.image} alt="profile picture"/>
                </div>
