        ...
        <header className="bg-white flex w-full justify-between py-5 px-20">
            ...
            <div>
                <ul className="flex font-['poppins'] space-x-10 mt-[20px]">
                    ...
                    <i className="not-italic"><a className="bg-[#EB5757] hover:text-black hover:bg-[#F2C94C] text-white px-[20px] py-[14px] rounded-[25px]" href="/login"><span className="fa fa-arrow-right-to-bracket mr-2"></span>Login</a></i>
                </ul>
            </div>
        </header>
    );
